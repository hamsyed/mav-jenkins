...
public class SampleSeleniumTest {
	...
	public void startBrowser() {
		System.setProperty("webdriver.chrome.driver", "C:\\Users\\shameed\\Desktop\\chromedriver.exe");
	...
	public void validateGoogleId() throws Exception {
		...
		//driver.findElement(By.xpath("//*[@id=\"identifierId\"]")).sendKeys("syed.hameed.uddin");
